            ...
            <div id="inscriptionForm" class="colum">
                ...
                <form action="confirm_inscription_Controller.php" method="post" name="action">
                    <div>
                        ...
                        <input class="inputInscription" type="text" name="username" id="username"  pattern="[a-z0-9]+" title="Caractères inaccentués minuscules et chiffres seulement" value="<? if (isset($username)) echo $username; ?>">
                    </div>
                    <? if (isset($username) && $username == "") echo '<span class="errorInput">', $empty_field ,'</span>'; ?>
                    <div>
                    ...
                    <? if (isset($name) && $name == "") echo '<span class="errorInput">', $empty_field ,'</span>'; ?>
                    <div>
                        <label for="mailadress">Adresse E-mail* :</label>
                        <input class="inputInscription" type="email" name="mail" id="mailadress" pattern="^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" value="<? if (isset($mail)) echo $mail; ?>">
                    </div>
                    <? if (isset($mail) && $mail == "") echo '<span class="errorInput">', $empty_field ,'</span>'; ?>
                    <div>
                    ...
                    <? if (isset($password) && $password == "") echo '<span class="errorInput">', $empty_field ,'</span>'; ?>
                    <div>
                    ...
                    <? if (isset($birthdate) && $birthdate == "") echo '<span class="errorInput">', $empty_field ,'</span>'; ?>
                    <div>
